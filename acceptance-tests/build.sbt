...
libraryDependencies += "org.http4s"             %% "http4s-blaze-client" % "0.23.13"    % Test
libraryDependencies += "org.http4s"             %% "http4s-circe"        % "0.23.17"    % Test
...
libraryDependencies += "org.typelevel"          %% "cats-effect"         % "3.4.4"      % Test
