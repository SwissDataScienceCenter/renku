...
libraryDependencies += "com.github.pureconfig"  %% "pureconfig"               % "0.17.3"     % Test
...
libraryDependencies += "org.http4s"             %% "http4s-blaze-client"      % "0.23.14"    % Test
libraryDependencies += "org.http4s"             %% "http4s-circe"             % "0.23.18"    % Test
libraryDependencies += "org.scalacheck"         %% "scalacheck"               % "1.17.0"     % Test
libraryDependencies += "org.scalatest"          %% "scalatest"                % "3.2.15"     % Test
libraryDependencies += "org.scalatestplus"      %% "selenium-3-141"           % "3.2.10.0"   % Test
libraryDependencies += "org.seleniumhq.selenium" % "selenium-http-jdk-client" % "4.9.0"      % Test
...
libraryDependencies += "org.typelevel"          %% "cats-effect"              % "3.4.10"      % Test
