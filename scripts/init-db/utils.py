...
from tenacity import retry, stop_after_attempt, stop_after_delay, wait_fixed, before_sleep_log



@retry(stop=(stop_after_attempt(200) | stop_after_delay(600)), wait=wait_fixed(3), reraise=True, before_sleep=before_sleep_log(logging, logging.WARNING))
