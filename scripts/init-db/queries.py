...
).format(client_id=sql.Placeholder("client_id"), redirect_uris=sql.Placeholder("redirect_uris"), client_secret=sql.Placeholder("client_secret"))
...
class DatabaseInit:
    ...
    def set_extensions_and_roles(self):           
        with self.connection.cursor() as curs:
            ...
            extensions = [sql.SQL("CREATE EXTENSION IF NOT EXISTS {};").format(sql.Identifier(ext)) for ext in self.extensions]
