...
/**
  ...
  */
trait HasValue[+Value, +This <: HasValueBase[Value]] extends HasValueBase[Value] {
  this: This =>
  ...
  def boxed[U >: Value, That](
    implicit e1: BoxedOrValidValue[Value],
    e2         : HasValueMapper[U, This, BoxedValue, That]
  ): That = e2.map(this) { _ => boxedValue }
  ...
  def unboxedAs[U >: Value, V: ValidValue, That](
    implicit e1: BoxedOrValidValue[Value],
    e2         : HasValueMapper[U, This, V, That]
  ): That = {
