...
author = 'Eric Bouillet, Julien Eberle, Fotis Georgatos, ' \
         'Jakub Chrobasik, Jiri Kuncar, Izabela Moise, ' \
         'Rok Roskar, Sofiane Sarni, Sandra Savchenko De Jong, ' \
...
latex_documents = [
    (
        ...
        'Eric Bouillet, Julien Eberle, Fotis Georgatos, Jakub Chrobasik, Jiri Kuncar, Izabela Moise, Rok Roskar, Sofiane Sarni, Sandra Savchenko De Jong, Johann-Michael Thiebaut, Olivier Verscheure',
        'manual'
    ),
]
