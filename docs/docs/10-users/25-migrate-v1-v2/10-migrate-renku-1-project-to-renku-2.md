...
**Tip:** If you would like to share a set of projects with a group, you can create a Renku 2.0 group! See [How to create a group](/docs/users/collaboration/guides/create-group).
