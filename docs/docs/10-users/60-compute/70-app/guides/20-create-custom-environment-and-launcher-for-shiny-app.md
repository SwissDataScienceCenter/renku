...
If you have a shiny app that does not need any additional R packages, you can instead use the simpler guide [How to set up a Shiny app launcher](set-up-shiny-app-launcher).
...
1. [How to add a code repository to your project](../../../code/guides/add-code-repository-to-project)
...
2. In _project-fork_, modify the `install.R` file to include the required R packages for your project, as explained [here](../../session/guides/install-packages-on-the-fly-in-your-session#r).
...
7. Add a session launcher to your Renku project with the following **Custom Environment** option as explained in [How to use your own docker image for a Renku session](../../environment/guides/use-your-own-docker-image-for-renku-session) considering the following parameters:
