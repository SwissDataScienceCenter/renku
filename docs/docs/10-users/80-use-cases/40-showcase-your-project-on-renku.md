...
1. Add a dedicated launcher for your Streamlit or Shiny app. For a Shiny app, see [How to set up a Shiny app launcher](../sessions/guides/set-up-shiny-app-launcher).
