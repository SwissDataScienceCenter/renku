...
2. If you’d also like to have a space for regular development work on your Renku project (for example an RStudio environment), create a session launcher via one of the following options:
    1. [How to add a session launcher to your project](/docs/users/sessions/guides/environments)
    2. [How to use your own docker image for a Renku session](/docs/users/sessions/guides/environments/use-your-own-docker-image-for-renku-session)
