...
Data connectors can be shared among projects. You do not need to create the same data connector for multiple projects. Check [How to link a data connector to your project](/docs/docs/10-users/40-data/guides/10-link-data-connector-to-project.md)!
