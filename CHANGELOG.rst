...
* **Renku CLI**: support moving files between datasets with ``renku mv`` (`CLI documentation <https://renku-python.readthedocs.io/en/latest/reference/commands.html#module-renku.cli.move>`__).
...
⭐️ CLI: Datasets metadata is editable. Please see the `Dataset documentation <https://renku-python.readthedocs.io/en/latest/reference/commands.html#module-renku.cli.dataset>`__ for details.
